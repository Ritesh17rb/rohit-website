...
// function playpause() {
//     document.getElementById("switchforsound").checked ? audio.play() : audio.pause();
// }
...
//         // Try to play audio after a user interaction
//         document.body.addEventListener('click', () => {
//             audio.play().catch(err => console.log('Playback still failed:', err));
//         }, { once: true });
//     });
// });
...
// console.log("%c Designed and Developed by Ritesh ", "background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;");
